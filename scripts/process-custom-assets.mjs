...
const compileDynamicChartHook = (options) => {
  ...
  const pathToSrcScript = isBuidStep
    ? join(options.dir.pathname, "scripts", "dynamic-chart-core.src.js")
    : join(process.cwd(), "public", "scripts", "dynamic-chart-core.src.js");
  const pathToOutScript = isBuidStep
    ? join(options.dir.pathname, "scripts", "dynamic-chart-core.js")
    : join(process.cwd(), "public", "scripts", "dynamic-chart-core.js");
  exec(
    "esbuild " +
      pathToSrcScript +
      " --bundle --outfile=" +
